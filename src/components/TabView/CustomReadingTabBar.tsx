...
import { Animated, Dimensions, LayoutChangeEvent, ScrollView, StyleSheet, Text, TouchableOpacity, View } from 'react-native';
...
export const CustomReadingTabBar = (props: MaterialTopTabBarProps) => {
